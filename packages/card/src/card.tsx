...
export const CardList = React.forwardRef<HTMLDivElement, CardListProps>(
  (props, ref) => {
    ...
    return (
      <Comp
        data-color={color ? color : undefined}
        className={cx('card-list', className)}
        ref={ref}
        {...rest}
      >
        {children}
...
export const CardBody = React.forwardRef<HTMLDivElement, CardBodyProps>(
  (props, ref) => {
    ...
    return (
      <Comp
        data-color={color ? color : undefined}
        className={cx('card-body', className)}
        ref={ref}
        {...rest}
      >
        {children}
...
export const CardImage = React.forwardRef<HTMLImageElement, CardImageProps>(
  (props, ref) => {
    ...
    return (
      <Comp
        data-color={color ? color : undefined}
        className={cx('card-image', className)}
        ref={ref}
        {...rest}
      >
        {children}
...
export const CardLink = React.forwardRef<unknown, LinkProps>(
  (props, ref) => {
    const {
      children,
      external,
