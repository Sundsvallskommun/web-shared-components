  ...
  return (
    ...
    >
      <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <g>
          <circle cx="12" cy="12" r="9.5" fill="none" strokeWidth="3.2" strokeLinecap="round">
            <animate
              attributeName="stroke-dasharray"
              dur="1.6s"
              calcMode="spline"
              values="0 150;42 150;55 150;35 150;"
              keyTimes="0;0.575;0.95;1"
