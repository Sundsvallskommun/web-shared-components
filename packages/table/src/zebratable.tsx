    ...
    <>
      {managedRows.length > 0 && (
        <table
          ...
          tabIndex={0}
        >
          <caption className="sr-only">Pågående Ärende
            <br/>
            <span>Kolumn ett har ärendenamnet och sista kolumnen har en knapp för att gå till ärendet.</span>
          </caption>
