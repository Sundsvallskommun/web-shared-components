...
interface AutoTableHeaderProps extends ZebraTableHeader {
  sortIndex: number;
...
export const AutoTableHeader: React.FC<AutoTableHeaderProps> = ({
  element,
    ...
    <>
      ...
      >
        {tableSortable && isColumnSortable ? (
          <>
            ...
            >
              ...
              <div className="sk-table-sortbutton-icon">
                {tableSortable && isColumnSortable && (
                  <span
                    className="sk-table-sortbutton-icon-sort"
          ...
          <span className={cx('sk-table-sortbutton', `${screenReaderOnly ? `sr-only` : ``}`)}>
